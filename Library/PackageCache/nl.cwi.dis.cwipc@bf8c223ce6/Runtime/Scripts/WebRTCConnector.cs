...
namespace Cwipc
{
    ...
    {
        public static WebRTCConnector Instance = new WebRTCConnector();
        ...
        {
            Debug.Log($"WebRTCConnector: AllConnectionsDone()");
            ...
            Debug.LogWarning($"WebRTCConnector: nTracks = {nTracks}");
