                ...
                if (u.userData.userRepresentationType == OrchestratorWrapping.UserData.eUserRepresentationType.__SPECTATOR__) { // Load Spectator
                    ...
                    switch (u.userData.userRepresentationType) {
                        case OrchestratorWrapping.UserData.eUserRepresentationType.__2D__:
                            ...
                            players[playerIdx].webcam.AddComponent<WebCamPipeline>().Init(players[playerIdx].orchestratorId, userCfg, u.sfuData.url_pcc, u.sfuData.url_audio);
                            // Audio
                        ...
                        case OrchestratorWrapping.UserData.eUserRepresentationType.__PCC_CWI_: // PC & AUDIO
                            ...
                            if (u.userData.userRepresentationType == OrchestratorWrapping.UserData.eUserRepresentationType.__PCC_CWI_)
                                players[playerIdx].pc.AddComponent<EntityPipeline>().Init(players[playerIdx].orchestratorId, userCfg, PCSourceType.PCSelf, u.sfuData.url_pcc, u.sfuData.url_audio);
                            else if (u.userData.userRepresentationType == OrchestratorWrapping.UserData.eUserRepresentationType.__PCC_SYNTH__)
                                players[playerIdx].pc.AddComponent<EntityPipeline>().Init(players[playerIdx].orchestratorId, userCfg, PCSourceType.PCSynth, u.sfuData.url_pcc, u.sfuData.url_audio);
                            else if (u.userData.userRepresentationType == OrchestratorWrapping.UserData.eUserRepresentationType.__PCC_CERTH__)
                                players[playerIdx].pc.AddComponent<EntityPipeline>().Init(players[playerIdx].orchestratorId, userCfg, PCSourceType.PCCerth, u.sfuData.url_pcc, u.sfuData.url_audio);
                            // xxxjack debug code
                            {
