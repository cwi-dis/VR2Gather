...
public class PerformanceMetrics : MonoBehaviour
{
    ...
    public void saveAndDestroy(string tvmObjName)
    {
        ...
        if (Config.Instance.TVMs.saveMetrics)
        {
            ...
            string expDirectory = System.IO.Path.Combine(System.IO.Directory.GetParent(Environment.GetEnvironmentVariable("AppData")).ToString(), "LocalLow", Application.companyName, Application.productName, "TVMPerfomanceLogs", DateTime.Now.ToString("yyyy-MM-dd-hh-mm-ss"));
