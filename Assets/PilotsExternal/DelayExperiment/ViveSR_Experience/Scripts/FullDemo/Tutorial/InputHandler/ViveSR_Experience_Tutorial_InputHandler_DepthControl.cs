...
{
    public class ViveSR_Experience_Tutorial_InputHandler_DepthControl : ViveSR_Experience_Tutorial_IInputHandler
    {
        protected override void AwakeToDo()
        {
            Button = ViveSR_Experience_Demo.instance.ButtonScripts[MenuButton.DepthControl];
        }
