...
namespace Vive.Plugin.SR.Experience
{
    ...
    public class ViveSR_Experience_StaticMesh : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ViveSR_RigidReconstructionRenderer.SetWireFrameThickness = 600f;
        }
        ...
        public void EnableDepthProcessingAndScanning(bool enable)
        {
            if (enable)
            {
                ViveSR_DualCameraRig.Instance.SetRenderTextureLevel(1);
            ...
            {
                if(ViveSR_DualCameraRig.Instance) ViveSR_DualCameraRig.Instance.SetRenderTextureLevel(0);
        ...
        private IEnumerator _ExportModel(System.Action<int> UpdatePercentage = null, System.Action done = null)
        {
            ...
            ViveSR_DualCameraRig.Instance.SetRenderTextureLevel(0);
