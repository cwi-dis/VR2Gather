...
{
    public class OrchestratorUserDelayPilot0 : MonoBehaviour
    {
        public static OrchestratorUserDelayPilot0 Instance { get; private set; }
        ...
        {
            Debug.Log("[OrchestratorUserDelayPilot0][OnLeaveSessionHandler] Session Leaved");
        ...
        private void OnUserJoinedSessionHandler(string userID)
        {
            ...
            {
                Debug.Log("[OrchestratorUserDelayPilot0][OnUserJoinedSessionHandler] User joined: " + userID);
            }
        }
        ...
        private void OnUserLeftSessionHandler(string userID)
        {
            if (!string.IsNullOrEmpty(userID))
            {
                Debug.Log("[OrchestratorUserDelayPilot0][OnUserLeftSessionHandler] User left: " + userID);
            }
        }
        ...
        {
            Debug.Log("[OrchestratorUserDelayPilot0][OnError]::Error code: " + status.Error + "::Error message: " + status.Message);
