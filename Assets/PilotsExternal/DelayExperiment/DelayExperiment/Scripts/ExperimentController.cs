...
public class ExperimentController : MonoBehaviour
{
    ...
    void SwitchToSceneVotation()
    {
        ...
        {
            ToDisable["OuterPlayer"].GetComponentInChildren<PointCloudRenderer>().baseMaterial.shader = Shaderclean;
    ...
    void SetNewCondition(Secuencias sequence)
    {
        ...
        if (ToDisable.ContainsKey("OuterPlayer"))
        {
            try
            {
                ...
                ToDisable["OuterPlayer"].GetComponentInChildren<PointCloudRenderer>().baseMaterial.shader = shaderAuxSave;
                ToDisable["OuterPlayer"].GetComponentInChildren<VRTSynchronizer>().minLatency = (long)sequence.retardo_numerico;
            }
    ...
    private void findLocalUser()
    {
        try
        {
            ...
            AuxVar.GetComponentInChildren<PointCloudRenderer>().baseMaterial.shader = Shaderclean;
    ...
    private void findOuterUser()
    {
        try
        {
            ...
            ToDisable["OuterPlayer"].GetComponentInChildren<VRTSynchronizer>().minLatency = (long)playlist.secuencias[0].retardo_numerico;
            ToDisable["OuterPlayer"].GetComponentInChildren<VRTSynchronizer>().latencyMaxIncrease = 100;
