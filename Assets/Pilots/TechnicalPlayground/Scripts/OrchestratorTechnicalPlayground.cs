...
{
    public class OrchestratorTechnicalPlayground : MonoBehaviour
    {
        public static OrchestratorTechnicalPlayground Instance { get; private set; }
        ...
        {
            Debug.Log("[OrchestratorTechnicalPlayground][OnLeaveSessionHandler] Session Leaved");
        ...
        private void OnUserJoinedSessionHandler(string userID)
        {
            ...
            {
                Debug.Log("[OrchestratorTechnicalPlayground][OnUserJoinedSessionHandler] User joined: " + userID);
            }
        }
        ...
        private void OnUserLeftSessionHandler(string userID)
        {
            if (!string.IsNullOrEmpty(userID))
            {
                Debug.Log("[OrchestratorTechnicalPlayground][OnUserLeftSessionHandler] User left: " + userID);
            }
        }
        ...
        {
            Debug.Log("[OrchestratorTechnicalPlayground][OnError]::Error code: " + status.Error + "::Error message: " + status.Message);
