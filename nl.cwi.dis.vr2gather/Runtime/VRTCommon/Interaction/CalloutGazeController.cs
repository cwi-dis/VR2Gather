...
{
    /// <summary>
    /// Fires events when this object is within the field of view of the gaze transform. Used to
    ...
    public class CalloutGazeController : MonoBehaviour
    {
        ...
        public void SetGazeTransform(Transform gazeTransform)
        {
            m_GazeTransform = gazeTransform;
        }
